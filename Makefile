...
SRC_CBM = src/cbm2.asm src/cbm2/init.asm src/cbm2/screen.asm src/cbm2/irq.asm src/cbm2/kbd.asm src/cbm2/serial.asm src/cbm2/vga.asm src/cbm2/vt52.asm src/cbm2/stub.asm src/cbm2/logger.asm
...
bin/emulcbm2.prg: $(SRC)
	ca65 src/main.asm -DPRG
	ld65 src/main.o -C src/main.cfg -o bin/emulcbm2.prg
	rm src/main.o

bin/emulcbm2_debug.prg: $(SRC)
